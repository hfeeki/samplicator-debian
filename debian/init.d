#!/bin/sh
### BEGIN INIT INFO
# Provides:          samplicator
# Required-Start:    $network $local_fs $remote_fs
# Required-Stop:     $remote_fs
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Send copies of (UDP) datagrams to multiple receivers
# Description:       Listens for UDP datagrams on a network port, and sends copies of these
...
do_stop()
{
	...
	start-stop-daemon --stop --quiet --signal KILL --pidfile $PIDFILE --name $NAME
	RETVAL="$?"
	[ "$RETVAL" = 2 ] && return 2
